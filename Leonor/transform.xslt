        ...
        <xsl:element name="html">
            ...
            <body>
                <header class="site-header">
                    <div class="wrapper">
                        <a class="site-title" rel="author" href="/">Charlotte Bishop Kessinger</a>
                        <nav class="site-nav">
                    ...
                    <div class="wrapper">
                        <div class="footer-col-wrapper">
                            <div class="footer-col">
                                ...
                                <ul class="contact-list">
                                    ...
                                    <li>
                                        <a class="u-email" href="mailto:cbk38@miami.edu"
                                            >cbk38@miami.edu</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="social-links">
                            <ul class="social-media-list">
                                <li>
                                    <a rel="me" href="https://github.com/charkessinger"
                                        title="charkessinger">
                                        <!--<svg class="svg-icon grey"></svg>--></a>
                                </li>
                                <li>
                                    <a rel="me" href="https://twitter.com/chakessinger" title="chakessinger">
                                        <!--<svg class="svg-icon grey"></svg>--></a>
                                </li>
                            </ul>
                        </div>
